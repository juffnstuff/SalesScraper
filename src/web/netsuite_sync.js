 ...
 * @returns {{ sales: { fetched, upserted }, estimates: { fetched, upserted }, openSales: { fetched, upserted }, sinceDate, durationMs }}
 */
...
module.exports = { runSync, getSyncStatus, getLastSyncDate, syncOpenSalesOrders };
